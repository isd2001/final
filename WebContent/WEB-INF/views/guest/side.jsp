...
<div class="sidebar-sticky">
	<ul class="nav flex-column">
		...
		<li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath }/private/mail.do"> <span
				data-feather="file"></span> Mail
		</a></li>
		<li class="nav-item"><a class="nav-link" href="${pageContext.servletContext.contextPath }/private/board.do"> <span
		...
		href="${pageContext.servletContext.contextPath }/chat/room.do"> <span
				data-feather="users"></span> Chat(All Department)
		</a></li>
		<li class="nav-item"><a class="nav-link ${ uri=='chat' ? 'active':'' }" 
		href="${pageContext.servletContext.contextPath }/chat/room.do"> <span
				data-feather="users"></span> Chat(Responsibility Department)
		</a></li> --%>
		<div class="nav-dropdown">
			<a class="nav-link" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
 		   chat(*)</a>
  			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    			<a class="dropdown-item ${ uri=='chat' ? 'active':'' }" href="${pageContext.servletContext.contextPath }/chat/Allchat.do">
    			All Department</a>
    			<a class="dropdown-item ${ uri=='chat' ? 'active':'' }" href="${pageContext.servletContext.contextPath }/chat/Departmentchat.do">
    			Responsibility Department</a>
  			</div>
